...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "length(trim(canonical_name)) > 0", name=op.f("ck_skills_canonical_name_not_blank")
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_education_current_has_no_end"),
        ),
        sa.CheckConstraint(
            "end_date IS NULL OR start_date IS NULL OR end_date >= start_date",
            name=op.f("ck_education_date_order"),
        ),
        sa.CheckConstraint(
            "length(trim(institution)) > 0", name=op.f("ck_education_institution_not_blank")
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "length(trim(company)) > 0", name=op.f("ck_experiences_company_not_blank")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["skill_id"],
            ["skills.id"],
            name=op.f("fk_skill_aliases_skill_id_skills"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "length(trim(text)) > 0", name=op.f("ck_experience_achievements_text_not_blank")
        ),
        sa.ForeignKeyConstraint(
            ["experience_id"],
            ["experiences.id"],
            name=op.f("fk_experience_achievements_experience_id_experiences"),
            ondelete="CASCADE",
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_experience_achievements_experience_id"), table_name="experience_achievements"
    )
